...
<div>
	...
	<main class="overflow-hidden">
		<div
			aria-hidden
			class="absolute inset-0 isolate z-10 hidden opacity-65 contain-strict lg:block"
		>
			<div
		...
		<section>
			<div class="relative mx-auto max-w-6xl px-6 pt-32 lg:pt-48 lg:pb-16">
				<div class="relative z-10 mx-auto max-w-4xl text-center">
					<h1 class="text-4xl font-medium text-balance sm:text-5xl md:text-6xl">
				...
				<div class="mx-auto md:-mt-20 lg:-mt-40">
					<div>
						<div class="relative mx-auto aspect-3/2 -rotate-30 lg:w-2/3">
							<div
								class="absolute inset-0 bg-linear-to-b from-background via-transparent to-background"
							></div>
							<div
								class="absolute inset-0 bg-linear-to-l from-background via-transparent to-background"
							></div>
							<!-- <img
